#ifndef ANALYZERGENSIM_H
#define ANALYZERGENSIM_H
//-----------------------------------------------------------------------------
// File:        analyzer.h
...
// --- Declare variables
//-----------------------------------------------------------------------------
std::vector<int>	GenParticle_charge(10000,0);
std::vector<double>	GenParticle_energy(10000,0);
std::vector<double>	GenParticle_et(10000,0);
std::vector<double>	GenParticle_eta(10000,0);
std::vector<double>	GenParticle_mass(10000,0);
std::vector<size_t>	GenParticle_numberOfDaughters(10000,0);
std::vector<size_t>	GenParticle_numberOfMothers(10000,0);
std::vector<double>	GenParticle_p(10000,0);
std::vector<int>	GenParticle_pdgId(10000,0);
std::vector<double>	GenParticle_phi(10000,0);
std::vector<double>	GenParticle_pt(10000,0);
std::vector<double>	GenParticle_px(10000,0);
std::vector<double>	GenParticle_py(10000,0);
std::vector<double>	GenParticle_pz(10000,0);
std::vector<int>	GenParticle_status(10000,0);
std::vector<double>	GenParticle_vx(10000,0);
std::vector<double>	GenParticle_vy(10000,0);
std::vector<double>	GenParticle_vz(10000,0);
double	GenRunInfoProduct_crossSection;
std::vector<float>	SimTrack_charge(10000,0);
std::vector<int>	SimTrack_genpartIndex(10000,0);
std::vector<double>	SimTrack_momentum_energy(10000,0);
std::vector<double>	SimTrack_momentum_eta(10000,0);
std::vector<double>	SimTrack_momentum_phi(10000,0);
std::vector<double>	SimTrack_momentum_pt(10000,0);
std::vector<int>	SimTrack_noGenpart(10000,0);
std::vector<int>	SimTrack_noVertex(10000,0);
std::vector<unsigned int>	SimTrack_trackId(10000,0);
std::vector<int>	SimTrack_type(10000,0);
std::vector<int>	SimTrack_vertIndex(10000,0);
std::vector<int>	SimVertex_noParent(10000,0);
std::vector<int>	SimVertex_parentIndex(10000,0);
std::vector<double>	SimVertex_position_t(10000,0);
std::vector<double>	SimVertex_position_x(10000,0);
std::vector<double>	SimVertex_position_y(10000,0);
std::vector<double>	SimVertex_position_z(10000,0);
std::vector<unsigned int>	SimVertex_vertexId(10000,0);
int	nGenParticle;
int	nSimTrack;
int	nSimVertex;
...
std::vector<GenParticle_s> GenParticle(10000);
...
std::vector<SimTrack_s> SimTrack(10000);
...
std::vector<SimVertex_s> SimVertex(10000);
