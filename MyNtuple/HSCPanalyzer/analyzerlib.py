...
def decodeCommandLine():
	...
	if argc > 2: 
		...
		cl.outputfilename = "/afs/desy.de/user/t/tlenz/importantDocuments/analyzerHSCP/" + cl.progname + "_histograms"
		os.symlink("~/importantDocuments/analyzerHSCP/" + cl.progname + "_histograms", cl.progname + "_histograms")
...
# -----------------------------------------------------------------------------
GenParticle_charge	= vector("int")(10000)
GenParticle_energy	= vector("double")(10000)
GenParticle_et	= vector("double")(10000)
GenParticle_eta	= vector("double")(10000)
GenParticle_mass	= vector("double")(10000)
GenParticle_numberOfDaughters	= vector("size_t")(10000)
GenParticle_numberOfMothers	= vector("size_t")(10000)
GenParticle_p	= vector("double")(10000)
GenParticle_pdgId	= vector("int")(10000)
GenParticle_phi	= vector("double")(10000)
GenParticle_pt	= vector("double")(10000)
GenParticle_px	= vector("double")(10000)
GenParticle_py	= vector("double")(10000)
GenParticle_pz	= vector("double")(10000)
GenParticle_status	= vector("int")(10000)
GenParticle_vx	= vector("double")(10000)
GenParticle_vy	= vector("double")(10000)
GenParticle_vz	= vector("double")(10000)
GenRunInfoProduct_crossSection	= Double()
SimTrack_charge	= vector("float")(10000)
SimTrack_genpartIndex	= vector("int")(10000)
SimTrack_momentum_energy	= vector("double")(10000)
SimTrack_momentum_eta	= vector("double")(10000)
SimTrack_momentum_phi	= vector("double")(10000)
SimTrack_momentum_pt	= vector("double")(10000)
SimTrack_noGenpart	= vector("int")(10000)
SimTrack_noVertex	= vector("int")(10000)
SimTrack_trackId	= vector("unsigned int")(10000)
SimTrack_type	= vector("int")(10000)
SimTrack_vertIndex	= vector("int")(10000)
SimVertex_noParent	= vector("int")(10000)
SimVertex_parentIndex	= vector("int")(10000)
SimVertex_position_t	= vector("double")(10000)
SimVertex_position_x	= vector("double")(10000)
SimVertex_position_y	= vector("double")(10000)
SimVertex_position_z	= vector("double")(10000)
SimVertex_vertexId	= vector("unsigned int")(10000)
nGenParticle	= Long()
nSimTrack	= Long()
nSimVertex	= Long()
