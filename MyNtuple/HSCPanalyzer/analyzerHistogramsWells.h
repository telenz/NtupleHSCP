#ifndef ANALYZERHISTOGRAMSWELLS_H
#define ANALYZERHISTOGRAMSWELLS_H
...
class Hist
{
 ...
 public:Hist(TString histName, outputFile ofile_)
  ...
  void FillTrackVariables_AODSIM(std::vector<evt::Track_s> inputCollection)
  {  
  ...
  void FillVertexHistograms(std::vector<evt::Vertex_s> inputCollection)
  {
  ...
  void FillGenParticleHistograms(std::vector<evt::GenParticle_s> inputCollection)
  {
    for(unsigned int i=0; i<inputCollection.size(); i++){
